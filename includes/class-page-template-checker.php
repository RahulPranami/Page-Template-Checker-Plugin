...
class Page_Template_Checker {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Page_Template_Checker_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'PAGE_TEMPLATE_CHECKER_VERSION' ) ) {
			$this->version = PAGE_TEMPLATE_CHECKER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'page-template-checker';
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-page-template-checker-public.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Page_Template_Checker_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Page_Template_Checker_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Page_Template_Checker_Loader    Orchestrates the hooks of the plugin.
	 */
